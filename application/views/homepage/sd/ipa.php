    ...
    <section class="team2 cid-sBMjNCRUDd" xmlns="http://www.w3.org/1999/html" id="team2-38">
                ...
                <div class="card-wrapper">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-md">
                            <div class="card-box">
                                <h5 class="card-title mbr-fonts-style m-0 display-5"><strong>Bambang S.Pd.</strong></h5>
                                <h6 class="mbr-fonts-style mb-3 display-4"></h6>
                                <p class="mbr-text mbr-fonts-style display-7"></p>
                                <p>Riwayat Pendidikan :</p>
                                <p><strong>s1 di university of oxford</strong></p><br>
                                <p>Riwayat Pekerjaan :&nbsp;</p>
                                <p><strong>Guru Honorer di SD Negeri 01 Sorong</strong></p><br>
                                <p>untuk lebih lanjut dapat menghubungi dengan pilihan dibawah :</p>
                                <p></p>
            ...
            <div class="card">
                <div class="card-wrapper">
                    <div class="row align-items-center">
                        <div class="col-12 col-md-4">
                            <div class="image-wrapper">
                                <img src="<?= base_url() ?>assets/home/images/team2.jpg" alt="Mobirise">
                            </div>
                        </div>
                        <div class="col-12 col-md">
                            <div class="card-box">
