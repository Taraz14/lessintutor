<section class="gallery3 cid-sAW7251G7h" id="gallery3-22">


    <div class="container-fluid">
        <div class="mbr-section-head">
            <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>Mata Pelajaran SMP</strong></h4>

        </div>
        <div class="row mt-4">
            <?php foreach ($getKelasSmp as $val) : ?>
